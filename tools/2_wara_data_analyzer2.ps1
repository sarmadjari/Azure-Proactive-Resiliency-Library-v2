...
$Global:Runtime = Measure-Command -Expression {
    ...
    function ExcelFile {
        ...
        function ExcelAPI {
            ...
            # Define the path to the OpenXML.dll file
            $OpenXMLDllPath = Join-Path -Path $PSScriptRoot -ChildPath "Libraries\OpenXML\OpenXML.dll"
        
            Write-Host "Creating Excel file..."
        
            try {
                # Check if the OpenXML.dll file exists
                if (-not (Test-Path -Path $OpenXMLDllPath -PathType Leaf)) {
                    Write-Host "OpenXML.dll is missing. Please run the OpenXML SDK installation script to ensure all required files are available." -ForegroundColor Yellow
                    return
                }
        
                # Load OpenXML SDK assembly
                Add-Type -Path $OpenXMLDllPath
        
                Write-Debug 'Opening Excel File'
        
                # Create a SpreadsheetDocument
                $spreadsheetDocument = [DocumentFormat.OpenXml.Packaging.SpreadsheetDocument]::Open($ExcelFile, $true)
        
                # Get WorksheetParts by name
                $pivotTableWorksheetPart = $spreadsheetDocument.WorkbookPart.WorksheetParts | Where-Object { $_.PartName -like "*PivotTable*" }
                $chartsWorksheetPart = $spreadsheetDocument.WorkbookPart.WorksheetParts | Where-Object { $_.PartName -like "*Charts*" }
        
                Write-Debug 'Moving Charts to Chart sheet'
        
                # Cut and Paste charts from PivotTable sheet to Charts sheet
                $pivotTableWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Descendants<DocumentFormat.OpenXml.Drawing.Spreadsheet.Picture>().ForEach{
                    $_.Remove()
                }
                $pivotTableWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Descendants<DocumentFormat.OpenXml.Drawing.Spreadsheet.GraphicFrame>().ForEach{
                    $_.Remove()
                }
                $pivotTableWorksheetPart.Worksheet.Save()
        
                $chartsWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Append($pivotTableWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Descendants())
                $chartsWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Append($pivotTableWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Picture>().Descendants())
                $chartsWorksheetPart.Worksheet.Save()
        
                Write-Debug 'Reloading Excel Chart Sheet'
        
                # Get WorksheetParts by name after moving charts
                $chartsWorksheetPart = $spreadsheetDocument.WorkbookPart.WorksheetParts | Where-Object { $_.PartName -like "*Charts*" }
        
                Write-Debug 'Editing ChartP0'
        
                # Edit ChartP0 in Charts sheet
                $chart0 = $chartsWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Descendants<DocumentFormat.OpenXml.Drawing.Spreadsheet.Chart>().Where{ $_.Name -eq 'ChartP0' }
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().Style = 222
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().X = 18
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().Y = 40
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.XPercentOffset]::new(0))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.YPercentOffset]::new(0))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.XYSizePercent]::new(100,100))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.LayoutMode]::new('edge'))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.LeftPercent]::new(0))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.TopPercent]::new(0))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.WidthPercent]::new(100))
                $chart0.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.HeightPercent]::new(100))
                $chart0.ChartSpace.Save()
        
                Write-Debug 'Editing ChartP1'
        
                # Edit ChartP1 in Charts sheet
                $chart1 = $chartsWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Drawing>().Descendants<DocumentFormat.OpenXml.Drawing.Spreadsheet.Chart>().Where{ $_.Name -eq 'ChartP1' }
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().Style = 222
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().X = 555
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().Y = 40
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.XPercentOffset]::new(0))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.YPercentOffset]::new(0))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.XYSizePercent]::new(100,100))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.LayoutMode]::new('edge'))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.LeftPercent]::new(0))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.TopPercent]::new(0))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.WidthPercent]::new(100))
                $chart1.ChartSpace.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Chart>().PlotArea.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.Layout>().ManualLayout.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.LayoutTarget>().SetFirstChild([DocumentFormat.OpenXml.Drawing.Charts.HeightPercent]::new(100))
                $chart1.ChartSpace.Save()
        
                Write-Debug 'Editing Pivot Filters'
        
                # Edit Pivot Filters in PivotTable sheet
                $pivotTableWorksheetPart.Worksheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.SheetData>().Elements<DocumentFormat.OpenXml.Spreadsheet.Row>() |
                Where-Object { $_.RowIndex -eq 1 } |
                ForEach-Object {
                    $_.Elements<DocumentFormat.OpenXml.Spreadsheet.Cell>() |
                    Where-Object { $_.CellValue.Text -eq 'Yes' -or $_.CellValue.Text -eq 'No' } |
                    ForEach-Object {
                        $_.CellValue.Text = 'No'
                    }
                }
